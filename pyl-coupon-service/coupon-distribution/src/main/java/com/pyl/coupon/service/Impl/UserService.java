...
import com.pyl.coupon.service.IUserService;
import com.pyl.coupon.vo.*;
 ...
 * 为什么使用 Kafka, 而不是直接使用 SpringBoot 中的异步处理 ?（一致性，异步有可能失败）
 * Created by PYL
 */
@Slf4j
@Service
public class UserService implements IUserService {
    ...
    @Autowired
    public UserService(CouponDao couponDao, IRedisService redisService, TemplateClient templateClient, SettlementClient settlementClient, KafkaTemplate kafkaTemplate) {
